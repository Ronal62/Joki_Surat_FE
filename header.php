...
<head>
    ...
    <title>Ronald Front End Developer</title>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link justify-content-between" href="#">
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <a href="surat_masuk.php"><span class="hide-menu">Surat Masuk</span></a>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link justify-content-between" href="#">
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <a href="surat_keluar.php"><span class="hide-menu">Surat Keluar</span></a>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link justify-content-between" href="#">
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <a href="surat_pengantar.php"><span class="hide-menu">Surat Pengantar</span></a>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link justify-content-between" href="#">
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <a href="surat_pendukung.php"><span class="hide-menu">Surat Pendukung</span></a>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link justify-content-between" href="#">
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <a href="surat_rahasia.php"><span class="hide-menu">Surat Rahasia</span></a>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link justify-content-between" href="#">
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <a href="surat_kependudukan.php"><span class="hide-menu">Surat Kependudukan</span></a>
                                        </div>
