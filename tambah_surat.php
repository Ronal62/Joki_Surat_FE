                        ...
                        <div class="card-body">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form action="">
                                        <div class="mb-3">
                                            <label for="exampleInputEmail1" class="form-label">Kode Arsip</label>
                                            <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukkan Nama">
                                        </div>
                                        <div class="mb-3">
                                            <label for="exampleInputNamaArsip1" class="form-label">Nama Arsip</label>
                                            <input type="text" class="form-control" id="exampleInputNamaArsip1" placeholder="Masukkan Nama Arsip">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control" id="exampleInputTanggal1" placeholder="Masukkan Tanggal">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="file" class="form-control" id="exampleInputFile1" placeholder="Upload File">
                                        </div>
